...
* Copyright (c) 2020 Apoorv Saxena; Licensed MIT */
    ...
    (() => {
        ...
        function initSliders() {
            if (document.querySelector(".media-block__slider")) new core(".media-block__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                speed: 800,
            ...
            if (document.querySelector(".stories-block__slider")) new core(".stories-block__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                speed: 800,
        ...
        if (isMobile.any()) {
            ...
            menuLinks.forEach((menuLink => menuLink.addEventListener("click", (e => {
                if (menuLink.nextElementSibling) if ("UL" === menuLink.nextElementSibling.tagName) {
                    e.preventDefault();
                    const subList = menuLink.nextElementSibling;
                    ...
                    menuLink.lastElementChild.classList.toggle("active");
                }
            }))));
        }
        const noLinkElems = document.querySelectorAll(".no-link");
        if (noLinkElems.length > 0) noLinkElems.forEach((noLinkElem => noLinkElem.addEventListener("click", (e => {
            e.preventDefault();
        }))));
        const popupVideoTriggers = document.querySelectorAll(".popup-video-trigger");
        const popupVideoBlock = document.querySelector(".popup__body--video");
        ...
        popupVideoTriggers.forEach((item => item.addEventListener("click", (() => {
            const videoUrl = item.dataset.video;
            modules_flsModules.popup.open("#video");
            if (popupVideoBlock.querySelector("iframe")) popupVideoBlock.querySelector("iframe").remove();
            setTimeout((() => {
                popupVideoBlock.append(iframeTemplate(videoUrl));
            }), 500);
        }))));
